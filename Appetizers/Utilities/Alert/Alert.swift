...
struct AlertContext {
    ...
    static let invalidURL        = AlertItem(title: Text("Server Error"), message: Text("There was an issue connecting. please conatct support."), dismissButton: .default(Text("OK")) )
    ...
    static let genericError  = AlertItem(title: Text("Error !"), message: Text("There is an Error, maybe generic Error "), dismissButton: .default(Text("OK")) )
